        ...
        <div className="row">
          <div className="col-12 col-md-6 order-2 order-md-1">
            ...
            <p className="mt-5 mx-5 mx-md-2">
              ...
              about mastering words; it&apos;s about immersing yourself in
              cultures, connecting with people, and embarking on a
              transformative journey. Our innovative web3 language learning
              platform offers more than just language lessons; it offers an
              immersive experience where language and culture intersect,
              creating a vibrant space for exploration, learning, and personal
              growth.
            </p>
            ...
            <p className="mt-5 mx-5 mx-md-2">
              ...
              confident real-world communication. That&apos;s why we&apos;ve
              crafted an environment that goes beyond the traditional classroom,
              allowing you to step into a world where language is a living,
              breathing entity.
            </p>
          </div>
